...
Now, this pseudo element needs to be added to this diff element here, so this one here because we cannot add it to images, okay? So the before and after pseudo elements cannot be added to images because, well, in the HTML themselves, we are not allowed to add child elements to images.
